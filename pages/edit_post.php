...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <form action="" method="post" id="f"><br>
            <center><h2>Gönderini düzenle:</h2></center>
            <br>
            <textarea class="form-control" cols="83" rows="4" name="content"><?php echo $post_con;?></textarea><br>
            <input type="submit" name="update" value="Gönderiyi Güncelle" class="btn btn-info"/>
        ...
        if (isset($_POST['update'])) {
            ...
            if ($run_update) {
                echo "<script>alert('Gönderi güncellendi!')</script>";
